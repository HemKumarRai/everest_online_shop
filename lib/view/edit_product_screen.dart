...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void initState() {
    ...
    productNameController = TextEditingController(text: widget.currentProduct.name);
    productPriceController = TextEditingController(text: widget.currentProduct.price.toString());
    productQuantityController = TextEditingController(text: widget.currentProduct.quantity.toString());
    productImageUrlController = TextEditingController(text: widget.currentProduct.productImage);
    super.initState();
  }
